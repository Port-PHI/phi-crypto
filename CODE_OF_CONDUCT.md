...
This Code of Conduct applies within all community spaces — the repository, issues, pull requests, and
any official communication channel — and also applies when an individual is officially representing
the community in public spaces. Examples include using an official email address, posting via an
...
maintainers responsible for enforcement at **conduct@portphi.com**. All complaints will be reviewed
